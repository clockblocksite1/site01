...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <div className='pooc'>
        <div className='root' onClick={handleShowAll}  >Все</div>
        <div className='wsx' onClick={handleShowHouses}  >Квартиры</div>
        <div className='wer'onClick={handleShowApartments}>Дома</div>
      </div>
      {showAll && (
      <div className='wero'>
        <div className='col'>
      ...
      <div className='bagi'>
        <div className='col'>
          ...
          <div className='line'></div>
          <img src={lcomImg}  style={{ borderRadius: '20px 0px 0px 0px' }} alt='' className='drok'/>
        </div>
        <div className='wrt'>
