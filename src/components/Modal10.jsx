  ...
  return (
    <div className='okno1010' ref={modalRef}>
      <div>
        ...
        <div className='hot49' onClick={handlePrevPhoto} style={{ borderRadius: '40px 0px 0px 40px' }}><HiOutlineArrowSmallLeft className='hot5'/></div>
        <div className='hot69' onClick={handleNextPhoto} style={{ borderRadius: '0 40px 40px 0' }}><HiOutlineArrowSmallRight className='hot7'/></div>
